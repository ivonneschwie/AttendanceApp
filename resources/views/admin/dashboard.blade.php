...
<div class="flex flex-col justify-center min-h-screen bg-gray-100 px-4 py-8">
    <div class="w-full max-w-4xl p-4 md:p-8 bg-white shadow-md rounded-lg mx-auto">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
            <h2 class="text-3xl font-bold mb-4 md:mb-0 text-center md:text-left">Welcome, Admin!</h2>
            <div class="flex flex-col md:flex-row">
                <a href="/admin/register-instructor" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full md:w-auto mb-2 md:mb-0 md:mr-2 text-center">Register Instructor</a>
