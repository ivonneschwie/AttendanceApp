    ...
    <div class="w-full max-w-4xl p-4 md:p-8 bg-white shadow-md rounded-lg mx-auto">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
            ...
            <div class="flex flex-col sm:flex-row">
                <a href="/instructor/create-room" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full sm:w-auto mb-2 sm:mb-0 sm:mr-2 text-center">Create Room</a>
