...
<div class="flex flex-col justify-center min-h-screen bg-gray-100 px-4 py-8">
    <div class="w-full max-w-4xl p-6 md:p-8 bg-white shadow-lg rounded-xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 border-b pb-4">
            <div class="min-w-0">
                <a href="/instructor/events" class="inline-flex items-center text-gray-500 hover:text-gray-700 mb-2">
                ...
                <p id="list-name" class="text-lg text-gray-600 truncate">{{ $event['createdAt'] ?? 'Attendance Scanner' }}</p>
            </div>
                ...
                <ul class="divide-y divide-gray-200">
                    @foreach ($attendance as $studentUid => $timestamp)
                        <li class="p-4 flex justify-between items-center hover:bg-gray-50 transition">
                            <div class="flex flex-col sm:flex-row sm:items-center student-entry cursor-pointer" data-student-uid="{{ $studentUid }}">
...
<!-- Edit Modal -->
<div id="edit-event-modal" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Make changes to the event name and date. Click save when you're done.
                                </p>
                                <div class="mt-4">
                                    <label for="name" class="block text-sm font-medium text-gray-700">Event Name</label>
                                    <input type="text" name="name" id="name" class="mt-1 shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ $event['name'] }}">
                                </div>
                                <div class="mt-4">
                                    <label for="createdAt" class="block text-sm font-medium text-gray-700">Event Date</label>
                                    <input type="text" name="createdAt" id="createdAt" class="mt-1 shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ $event['createdAt'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white px-4 pt-5 pb-4 md:p-6 md:pb-4">
                    <div class="md:flex md:items-start">
                        ...
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:text-left">
                            ...
                            <p class="text-sm text-gray-500">Are you sure you want to remove <strong id="student-name-to-remove"></strong> from this event? Their attendance for this event will be removed.</p>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-4 py-3 md:px-6 md:flex md:flex-row-reverse">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        removeStudentButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                removeStudentForm.action = `/instructor/event/{{ $eventId }}/student/${studentUid}/remove`;
